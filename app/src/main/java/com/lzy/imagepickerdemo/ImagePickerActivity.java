...
public class ImagePickerActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener, CompoundButton.OnCheckedChangeListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagePicker.setHideImageFolders(new String[]{Environment.getExternalStorageDirectory().getAbsolutePath() + "/watermark/",Environment.getExternalStorageDirectory().getAbsolutePath() + "/com.sgcc.pda.mdrh/download/1"});
