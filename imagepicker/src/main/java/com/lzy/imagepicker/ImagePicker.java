...
public class ImagePicker {
    ...
    private String[] hideImageFolders;//不让用户看到的文件件
    ...
    public String[] getHideImageFolders() {
        return hideImageFolders;
    }

    public void setHideImageFolders(String[] hideImageFolders) {
        this.hideImageFolders = hideImageFolders;
    }
